PROGRAM postproc_modpk
  ...
  IMPLICIT NONE
  INTEGER*4 :: i,j,l,ii
  REAL*8 :: kin, pow, powt, kmin, kmax, dlnk, pmin, pmax, k002,ps002,pt002
        ...
        DO i=1,10000
           ...
           IF(pk_bad==0) THEN    
              ...
              IF(vparams_num.GT.1) THEN
                 WRITE(12,'(14E27.18)') infile(1:2), modpk_ns002, modpk_r002, modpk_nrun002, LOG(1.d10*ps002), LOG(1.d10*modpk_As), modpk_ns, modpk_r, &
                      modpk_nrun, N_pivot, modpk_w, vparams(1), vparams(2)   
              ELSE
                 WRITE(12,'(13E27.18)') infile(1:2), modpk_ns002, modpk_r002, modpk_nrun002, LOG(1.d10*ps002), LOG(1.d10*modpk_As), modpk_ns, modpk_r, &
