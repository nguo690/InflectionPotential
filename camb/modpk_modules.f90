...
! increase max_vparams to use more potential parameters
  INTEGER*4, parameter :: max_vparams = 20

  INTEGER :: vparams_num
  INTEGER :: potential_choice
  INTEGER :: num_knots ! For free-form potential reconstruction
  REAL*8 :: vparams(max_vparams)
  REAL*8 :: vparams_saved(max_vparams) = 0d0
  ...
  REAL*8 :: modpk_ns002, modpk_nt002, modpk_nrun002, modpk_As002, modpk_r002
